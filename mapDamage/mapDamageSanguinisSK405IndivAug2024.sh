#!/bin/bash
 ...
 #SBATCH --mem=200gb
 #SBATCH --account=one
 #SBATCH --output=XXXXX/MapDamage/SanguinisOut.txt
 #SBATCH --error=XXXXX/MapDamage/SanguinisError.txt
...
MAPDAMAGEPATHS=XXXXX/MapDamage/Samples
...
ref=XXXXX/IndividualAlignments/References/Streptococcus_sanguinis/Streptococcus_sanguinis_SK405
