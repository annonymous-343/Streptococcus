#!/bin/bash
 ...
 #PBS -l pmem=6gb
 #PBS -A open
 #PBS -o IndividualAlignments
 #PBS -e IndividualAlignments
...
ref=IndividualAlignments/References/Streptococcus_gordonii/Streptococcus_gordonii_NCTC10231

# Path to directory with Samples (each in their own directory)
PATHS=IndividualAlignments/Samples
