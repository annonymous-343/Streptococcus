...
ancientCMrawdata <- read.delim("~/Desktop/XXXX/CompetitiveMappingBarPlots/Ancient-AllSpeciesCollectedCompetitiveMappingResults.txt", header = TRUE, check.names = FALSE)
dates <- read.delim("~/Desktop/XXXX/CompetitiveMappingBarPlots/BritishFormattedDates_3-7-2024.txt", header = TRUE, check.names = FALSE)
...
ggsave("ancientCM-stack.svg", "~/Desktop/XXXX/CompetitiveMappingBarPlots", plot = ancientCMplot, device = "svg", width = 13, height = 8)
#ggsave("ancientCM.svg", "~/Desktop/XXXX/CompetitiveMappingBarPlots", plot = ancientCMplot, device = "svg", width = 13, height = 8)
...
mutansancientCMplot <- ggplot(mutansancientCM_long, aes(x = factor(Sample, orderedsamplelistancientmutansgroup), y = ReadCount, fill = Species)) + 
  ...
  theme(axis.text.x=element_text(angle=90, hjust=1, vjust=0.5, color = "black", size = 8), 
        axis.text.y = element_text(color = "black", size = 10)) +
  scale_fill_manual(values = c("#000000", "#543005","#8c510a","#bf812d","#dfc27d","#f6e8c3","#f5f5f5","#c7eae5","#80cdc1","#35978f","#01665e","#003c30"))
ggsave("~/Desktop/XXXX/CompetitiveMappingBarPlots/mutansancient.pdf", plot = mutansancientCMplot, width = 13, height = 8)

###########################################################################
healthymodernCMrawdata <- read.delim("~/Desktop/XXXX/CompetitiveMappingBarPlots/HealthyModern-AllSpeciesCollectedCompetitiveMappingResults.txt", header = TRUE, check.names = FALSE)
periomodernCMrawdata <- read.delim("~/Desktop/XXXX/CompetitiveMappingBarPlots/PerioModern-AllSpeciesCollectedCompetitiveMappingResults.txt", header = TRUE, check.names = FALSE)
...
#ggsave("combinedmodernCM.svg", "~/Desktop/XXXX/CompetitiveMappingBarPlots", plot = combinedmodernCMplot, device = "svg", width = 7.5, height = 8)
ggsave("combinedmodernCM-stackedTEST.svg", "~/Desktop/XXXX/CompetitiveMappingBarPlots", plot = combinedmodernCMplot, device = "svg", width = 7.5, height = 8)
...
ggsave("~/Desktop/XXXX/CompetitiveMappingBarPlots/mutansmodern.pdf", plot = muttansmodernCMplot, width = 13, height = 8)
