...
# Define paths
PATHS=/GenomeAnalysis/CoverageAnalysis
...
REF=/IndividualAlignments/References/Streptococcus_sanguinis/Streptococcus_sanguinis_SK405
...
for Sample in /CompetitiveMapping/PerioModernSamples/Sample-*
