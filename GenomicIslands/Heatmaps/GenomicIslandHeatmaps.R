...
# Read in data
# Coverage summary
#rawdata <- read.delim("~/Desktop/XXXXXStreptococcus_spDD04_GenomicIslandCoverageSummary.txt", header = TRUE, check.names = FALSE)
rawdata <- read.delim("~/Desktop/XXXXXStreptococcus_sanguinis_GenomicIslandCoverageSummary_Combined.txt", header = TRUE, check.names = FALSE)
# Island attributes
#rawislanddata <- read.delim("~/Desktop/XXXXXStreptococcus_spDD04_GenomicIslandAttributes.txt", header = TRUE, check.names = FALSE)
rawislanddata <- read.delim("~/Desktop/XXXXXStreptococcus_sanguinis_GenomicIslandAttributes.txt", header = TRUE, check.names = FALSE)
# Sample attributes
#rawsampledata <- read.delim("~/Desktop/XXXXXStreptococcus_spDD04_SampleAttributes.txt", header = TRUE, check.names = FALSE)
rawsampledata <- read.delim("~/Desktop/XXXXXStreptococcus_sanguinis_SampleAttributes_Combined.txt", header = TRUE, check.names = FALSE)
# Island characterization (made afer filtered islands)
#islandcharacterization <- read.delim("~/Desktop/XXXXXDD04_Characterization.txt", header = TRUE, check.names = FALSE)
islandcharacterization <- read.delim("~/Desktop/XXXXXSanguinis_Characterization.txt", header = TRUE, check.names = FALSE)
...
write_tsv(selectedislandcharacterization_rowlabels, "~/Desktop/XXXXXSanguinis-sortedcharacterizations.tsv")
...
pdf("~/Desktop/XXXXXSanguinisHM_01212024.pdf", width = 11, height = 8)
#pdf("~/Desktop/XXXXXSinensisHM_01212024.pdf", width = 11, height = 8)
draw(Heatmap)
dev.off()
