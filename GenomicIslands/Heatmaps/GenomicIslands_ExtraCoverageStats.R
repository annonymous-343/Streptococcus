...
# Read in data
# Coverage summary
rawdata <- read.delim("~/Desktop/XXXXX/GenomicIslands/Streptococcus_spDD04_GenomicIslandCoverageSummary.txt", header = TRUE, check.names = FALSE)
#rawdata <- read.delim("~/Desktop/XXXXX/GenomicIslands/Streptococcus_sanguinis_GenomicIslandCoverageSummary_Combined.txt", header = TRUE, check.names = FALSE)
# Island attributes
rawislanddata <- read.delim("~/Desktop/XXXXX/GenomicIslands/Streptococcus_spDD04_GenomicIslandAttributes.txt", header = TRUE, check.names = FALSE)
#rawislanddata <- read.delim("~/Desktop/XXXXX/GenomicIslands/Streptococcus_sanguinis_GenomicIslandAttributes.txt", header = TRUE, check.names = FALSE)
# Sample attributes
rawsampledata <- read.delim("~/Desktop/XXXXX/GenomicIslands/Streptococcus_spDD04_SampleAttributes.txt", header = TRUE, check.names = FALSE)
#rawsampledata <- read.delim("~/Desktop/XXXXX/GenomicIslands/Streptococcus_sanguinis_SampleAttributes_Combined.txt", header = TRUE, check.names = FALSE)
# Island characterization (made afer filtered islands)
islandcharacterization <- read.delim("~/Desktop/XXXXX/GenomicIslands/DD04_Characterization.txt", header = TRUE, check.names = FALSE)
#islandcharacterization <- read.delim("~/Desktop/XXXXX/GenomicIslands/Sanguinis_Characterization.txt", header = TRUE, check.names = FALSE)
...
# Save
write.table(results, file = "~/Desktop/XXXXX/GenomicIslands/GIPresenceOverTime.txt",        # Specify your desired file path
