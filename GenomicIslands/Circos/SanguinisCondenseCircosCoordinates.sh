...
outdir=/GenomeAnalysis/CircosPlot/Streptococcus_sanguinis_SK405_plot-03072024/SampleCoverages/CompressedHighlights

mkdir $outdir

# Assumes data is already sorted by contig/chromosome and then in position order, as it would be following prior script
for file in /GenomeAnalysis/CircosPlot/Streptococcus_sanguinis_SK405_plot-03072024/SampleCoverages/highlights.reads.*.txt
 do
