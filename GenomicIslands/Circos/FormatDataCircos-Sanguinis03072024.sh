...
# Working directory
PATHS=/GenomeAnalysis/CircosPlot/Streptococcus_sanguinis_SK405_plot-03072024

# faidx file of reference genome with path. Made with reference FASTA and samtools
FAIDX=/IndividualAlignments/References/Streptococcus_sanguinis/Streptococcus_sanguinis_SK405.fai

# Specify FASTA file with path to calculate GC coverage
FASTAFILE=/IndividualAlignments/References/Streptococcus_sanguinis/Streptococcus_sanguinis_SK405
...
BAM=/IndividualAlignments/Samples/Sample-"$NAME"/Streptococcus_sanguinis/"$NAME"_mapped_q30_sorted_rmdup_uniq.bam
...
BAM=/CompetitiveMapping/PerioModernSamples/Sample-19778_ModernCalculus_PerioDisease_12_kneaddata/Streptococcus_sanguinis/19778_ModernCalculus_PerioDisease_12_kneaddata_mapped_q30_sorted_rmdup_uniq.bam

bedtools genomecov -ibam $BAM -bg > $OUTDIR/histogram.coverage."$NAME".txt
cat $OUTDIR/histogram.coverage."$NAME".txt | cut -f1,2,3 > $OUTDIR/highlights.reads."$NAME".txt

NAME=18760_HealthyModern_5_Calculus_kneaddata
BAM=/CompetitiveMapping/HealthyModernSamples/Sample-18760_HealthyModern_5_Calculus_kneaddata/Streptococcus_sanguinis/18760_HealthyModern_5_Calculus_kneaddata_mapped_q30_sorted_rmdup_uniq.bam
