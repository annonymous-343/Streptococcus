...
# PATHS=/GenomeAnalysis/GenomicIslands/ByWholeIsland_SanguinisIndividualMapping-03062024
PATHS=/GenomeAnalysis/GenomicIslands/ByWholeIsland_DD04AncientIndividualMapping-03062024

# Existing output directory for formatted ontology lists
outdir=$PATHS/CharacterizingIslands/OntologyLists

islandtable=/GenomeAnalysis/GenomicIslands/DD04GenomicIslands-03052024.txt
#islandtable=/GenomeAnalysis/GenomicIslands/SanguinisGenomicIslands–03062024.txt

# for naming
NAME=DD04

# Directory with island files (from coverage script)
#islandfiles=/GenomeAnalysis/GenomicIslands/ByWholeIsland_SanguinisIndividualMapping-03062024/GenomicIslands
islandfiles=/GenomeAnalysis/GenomicIslands/ByWholeIsland_DD04AncientIndividualMapping-03062024/GenomicIslands

# List of filtered islands (above 2000 bp cut off)
listofislands=/GenomeAnalysis/GenomicIslands/ByWholeIsland_DD04AncientIndividualMapping-03062024/Filtered_islands_2000bp.txt
#listofislands=/GenomeAnalysis/GenomicIslands/ByWholeIsland_SanguinisIndividualMapping-03062024/Filtered_islands_2000bp.txt

# UniProt results with island names
#uniprot=/GenomeAnalysis/GenomicIslands/ByWholeIsland_SanguinisIndividualMapping-03062024/CharacterizingIslands/uniprotoutput_withislandnames.txt
uniprot=/GenomeAnalysis/GenomicIslands/ByWholeIsland_DD04AncientIndividualMapping-03062024/CharacterizingIslands/uniprotoutput_withislandnames.txt
...
Rscript /GenomeAnalysis/GenomicIslands/ReviGoScripts/revigo-bioprocesses.R $outdir/"$island"/"$island"_ontologieslist.txt $outdir/"$island"/"$island"_tempprocesses.txt
...
Rscript /GenomeAnalysis/GenomicIslands/ReviGoScripts/revigo-molecularfunction.R $outdir/"$island"/"$island"_ontologieslist.txt $outdir/"$island"/"$island"_tempprocesses.txt
...
Rscript /GenomeAnalysis/GenomicIslands/ReviGoScripts/revigo-cellularcomponent.R $outdir/"$island"/"$island"_ontologieslist.txt $outdir/"$island"/"$island"_tempprocesses.txt
