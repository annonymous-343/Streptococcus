...
dates <- read.delim("~/XXXXXX/BritishFormattedDates_3-7-2024.txt", header = TRUE, check.names = FALSE)
...
placementtree <- read.tree("/Users/XXXXX/Desktop/Phylogenetics/RAxML_bipartitions.LargeTreeCMCleanedHalfGaps") # Competitive mapping
