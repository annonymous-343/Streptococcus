...
echo "Working on $Sample"
 cd XXXXX/IndividualAlignments/Samples/Sample-"$Sample"/Streptococcus_spDD04_Strict/Streptococcus_spDD04_Strict_VariantCallingandConsensus
