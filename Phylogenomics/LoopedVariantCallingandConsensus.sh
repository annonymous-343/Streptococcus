...
REF=XXXXX/IndividualAlignments/References/Streptococcus_spDD04/Streptococcus_sp._DD04

# bcftools program and plugins files (plugin files downloaded automatically as part of bcftools)
bcftools=XXXXX/Phylogenetics/bcftools/bin/bcftools
setGTplugin=+XXXXX/Phylogenetics/bcftools/libexec/bcftools/setGT.so
filltagsplugin=+XXXXX/Phylogenetics/bcftools/libexec/bcftools/fill-tags.so

# Path to directories with samples
PATHS=XXXXX/IndividualAlignments/Samples
...
SUMOUT=XXXXX/Phylogenetics

# File with list of sample names to create consensus sequences for
LIST=XXXXX/Phylogenetics/SspDD04Samples.txt
